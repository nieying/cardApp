...
angular.module('cardApp').controller('scanSetPwdCtrl',['$scope', '$rootScope', '$state', 'encodeService', 'dataService', function ($scope, $rootScope, $state, encodeService, dataService) {
